...
if(TARGET glog::glog)
  message(STATUS "TiledCuda: Found glog with new-style glog target.")
elseif(GLOG_FOUND)
  message(
    STATUS
      "TiledCuda: Found glog with old-style glog starget. Glog never shipped "
  ...
  message(
    STATUS "TiledCuda: Cannot find glog automatically. Using legacy find.")
  ...
  if(GLOG_FOUND)
    message(STATUS "TiledCuda: Found glog (include: ${GLOG_INCLUDE_DIR}, "
...
if(NOT TARGET glog::glog)
  message(WARNING "TiledCuda: glog cannot be found.")
endif()

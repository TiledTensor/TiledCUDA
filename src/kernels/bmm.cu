...
//     Element* gA_ptr =
//         const_cast<Element*>(dA) + blockIdx.x * kK * kTM + blockIdx.z * kK *
//         kM;
//     Element* gB_ptr =
//         const_cast<Element*>(dB) + blockIdx.y * kK * kTN + blockIdx.z * kK *
//         kN;
//     Element* gC_ptr =
...
//                             torch::Tensor& c, int64_t m, int64_t n, int64_t
//                             k, int64_t batch_count) {
